...
const Home = () => {
  ...
  useEffect(() => {
    const typed = new Typed(typedElement.current, {
      strings: ['Welcome To Saksham Softech'],
      typeSpeed: 50,
      backSpeed: 30,
      loop: true,
    });
    ...
    <div className="w-full flex flex-col items-center">
      ...
      <div className="relative w-full h-screen overflow-hidden" id='hcontainer'>
        ...
        <div  className="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-6">
          ...
          <p className="mt-4 text-lg md:text-xl max-w-3xl floating">
            Your one-stop solution for modern, high-performance, and fully responsive web development.
          </p>
          <button className="mt-6 px-6 py-3 bg-blue-600 hover:bg-blue-700 rounded-full text-lg font-semibold transition-all shadow-lg hover:scale-105 floating" onClick={getstart}>
            Get Started
          </button>
        </div>
      </div>
      ...
      <div  className="mt-4 mb-6 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-4 w-[96.9%]" >
        {/* Card 1 */}
        <div className="bg-primary text-white p-4 flex flex-col items-center text-center rounded-lg shadow-lg transform transition duration-300 hover:scale-105 floating">
